...
%\caption{A summary of the foundational assumptions of each method.}
%\label{tab.assumptions}
%\end{table}
%
%\begin{table}
%\input{tables/table_modelresults.tex}
%\caption{A summary of the answers for each method across the four central questions. {\em Depends} indicates cases where the %method can succeed depending on parameters, but the correct parameterization is difficult to discern.} 
